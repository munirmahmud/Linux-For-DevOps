...
মনে করেন CPU হলো একটা **রান্নাঘরের বাবুর্চি।**
...
Load Average = 2.0  →  2টা core-এর কাজ আসছে (যদি core 1টা হয় → overloaded!)
```
...
| Part | মানে |
|---|---|
| `interval` | কত সেকেন্ড পর পর update দেবে |
| `count` | কতবার দেখাবে |
...
mpstat -P ALL 2 3
```
Run করুন এবং বলুন, `%idle` কত? কোনো core কি অন্যটার চেয়ে বেশি busy?
