...
Linux-এ যখন আমরা কোনো command run করি, সেটা default-এ **foreground**-এ চলে, মানে terminal টা block হয়ে যায়। কিন্তু DevOps কাজে আমাদেরকে অনেক সময় একসাথে অনেক কাজ করতে হয়। সেজন্যই দরকার Job Control।
...
আগে Concept বোঝার চেস্টা করি। ধরেন আপনি একটা রেস্তোরাঁর manager।

| পরিস্থিতি | Linux-এ |
|---|---|
| আপনি নিজে কাউন্টারে দাঁড়িয়ে সরাসরি order নিচ্ছেন | **Foreground process** - terminal ব্লক |
...
Terminal এখন free! আপনি অন্য command রান করতে পারবেন।
...
বর্তমানে যদিও আমরা এভাবে deploy করি না। তবে অনেক ক্ষেত্রে long script চালানো লাগতে পারে। 
